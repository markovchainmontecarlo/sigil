...
export const RUNTIME_RESOURCE_GROUPS: readonly RuntimeResourceGroup[] = [
  ...
  { source: "src/workflows/software-change/planning/prompts", destination: "workflows/software-change/planning/prompts", files: ["buildTaskGraph.md", "comparePlans.md", "enrichTaskGraph.md", "fixJson.md", "investigate.md", "plannerRubric.md", "repairTaskGraph.md", "resolveDivergences.md", "reviewTaskGraph.md", "synthesisRubric.md", "verifyClaims.md", "writePlan.md"] },
