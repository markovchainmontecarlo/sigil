...
export const RUNTIME_RESOURCE_GROUPS: readonly RuntimeResourceGroup[] = [
  ...
  { source: "src/workflows/software-change/planning/prompts", destination: "workflows/software-change/planning/prompts", files: ["buildTaskGraph.md", "comparePlans.md", "enrichTaskGraph.md", "fixJson.md", "investigate.md", "resolveDivergences.md", "verifyClaims.md", "writePlan.md"] },
  { source: "src/workflows/software-change/implementation/prompts", destination: "workflows/software-change/implementation/prompts", files: ["noopCheck.md", "preamble.md", "repair.md", "sessionHandoff.md", "task.md"] },
