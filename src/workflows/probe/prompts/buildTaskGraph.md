...
2. Create one coherent task per independently verifiable product improvement.
...
4. Write acceptance criteria as observable outcomes that prove the improved user experience.
5. Write the task graph as JSON to {{OUT_FILE}}, with repo-relative files[].path values and valid dependency ids. Match this contract:
