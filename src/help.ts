...
export const commandHelps = [
  {
    ...
    flags: [
      ...
      { name: "status", description: "Show redacted admission policy, active assignments and reserved headroom, remaining-capacity class, and circuit reason/state; never show homes or account credentials." },
    ],
